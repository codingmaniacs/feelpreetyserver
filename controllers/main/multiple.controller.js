const Multiple = require('../../models/main/multiple.model.js');
...
exports.create = (req, res) => {
    ...
    const multiple = new Multiple({
        ...
        name: req.body.name || "No multiple name", 
        description: req.body.description || "No multiple description",
        imagePath: req.body.imagePath || "No image_path"
