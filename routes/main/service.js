...
module.exports = (app) => {
    const services = require('../../controllers/main/services.controller.js');
...
/*
    ...
    app.get('/services/:category_id', services.getServicesByCategoryID);
    ...
    app.post('/services_byfilter/', services.getServicesByFilter);
